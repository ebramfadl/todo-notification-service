...
public class RabbitMQConfig {
    ...
    public static final String DEADLINE_ALERT_EXCHANGE = "deadline_alert_exchange";
    public static final String DEADLINE_ALERT_QUEUE = "deadline_alert_queue";
    public static final String DEADLINE_ALERT_ROUTING_KEY = "deadline.alert.notification";
    ...
    @Bean
    public TopicExchange deadlineAlertExchange() {
        return new TopicExchange(DEADLINE_ALERT_EXCHANGE);
    }

    @Bean
    public Queue deadlineAlertQueue() {
        return new Queue(DEADLINE_ALERT_QUEUE, true);
    }

    @Bean
    public Binding deadlineAlertBinding(Queue deadlineAlertQueue, TopicExchange deadlineAlertExchange) {
        return BindingBuilder
                .bind(deadlineAlertQueue)
                .to(deadlineAlertExchange)
                .with(DEADLINE_ALERT_ROUTING_KEY);
    }
